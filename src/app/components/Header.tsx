      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex-1 md:flex-none">
          <button
            ...
            className="text-xl sm:text-2xl lg:text-3xl tracking-wider text-[#D63384] hover:opacity-80 transition-opacity"
        ...
        <nav className="hidden md:flex items-center gap-6 lg:gap-8 flex-1 justify-center">
          <button
            onClick={() => onNavigate?.('catalog', { category: null })}
          ...
          <button
            onClick={() => onNavigate?.('catalog', { category: 'Onglerie' })}
            className="text-[#D63384] hover:text-[#064E3B] transition-colors text-sm lg:text-base"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            Ongles
          ...
          <button
            onClick={() => onNavigate?.('catalog', { category: 'Soins des Cheveux' })}
            className="text-[#D63384] hover:text-[#064E3B] transition-colors text-sm lg:text-base"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            Soins
        ...
        <div className="flex items-center gap-3 sm:gap-4 md:gap-6 flex-1 md:flex-none justify-end">
          <button
            ...
            className="text-[#D63384] hover:text-[#064E3B] transition-colors hidden md:block p-2"
